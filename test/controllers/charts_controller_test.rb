...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { distance: @chart.distance, planet: @chart.planet, temperature: @chart.temperature } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { distance: @chart.distance, planet: @chart.planet, temperature: @chart.temperature } }
